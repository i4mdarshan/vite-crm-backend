...
class CustomerLeadContacts extends Model
{
    use HasFactory;
    ...
    {
        $contact_info = new CustomerLeadContacts;
        ...
        if(request()->hasFile('contact_image')){
            $name = date("Y_m_d_h_i_s_").$request->file('contact_image')->getClientOriginalName();
    ...
    {
        // dd($request);
        $contact_info = CustomerLeadContacts::findOrFail($contact_id);
    ...
    protected $table = 'customer_lead_contacts';
}
