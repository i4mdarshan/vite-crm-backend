        ...
        <div class="row">
            <div class="col-md-12 mb-3">
                <div class="card shadow">
                    ...
                    <div>
                        <form id="updateQuotation" action="{{ route('update_quotations',$quotation_details->id) }}" method="POST">
                            @csrf
                            <div class="m-3">
                                    ...
                                    <div class="col-md-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <select name="quotation_type"
                                                ...
                                                id="quotation_type" disabled>
                                                <option value="">Choose Status</option>
                                                <option value="quotation" {{ old("quotation_type",$quotation_details->quotation_type) == "quotation" ? "selected" : "" }}>Quotation</option>
                                                <option value="proforma_invoice" {{ old("quotation_type",$quotation_details->quotation_type) == "proforma_invoice" ? "selected" : "" }}>Proforma Invoice</option>
                                                <option value="sample_request" {{ old("quotation_type",$quotation_details->quotation_type) == "sample_request" ? "selected" : "" }}>Sample Request</option>
                                                <option value="pending_order_form" {{ old("quotation_type",$quotation_details->quotation_type) == "pending_order_form" ? "selected" : "" }}>Pending Order Form</option>
                                            </select>
                                    ...
                                    <div class="col-md-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="quotation_date" min="{{ now()->format('Y-m-d') }}"
                                                ...
                                                id="quotation_date" value="{{ old("quotation_date",now()->format('Y-m-d')) }}" readonly>
                                    ...
                                    <div class="col-md-6 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="firm_name" class="form-control" id="firm_name">
                                                ...
                                                @foreach ($firms as $firm)
                                                    <option value="{{ $firm->id }}" {{ (old("firm_name",$quotation_details->firm_id) == $firm->id) ? "selected" : "" }}>{{ ucwords($firm->firm_name) }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('firm_name')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" name="firm_address" rows="4" id="firm_address"
                                                class="form-control form-control-sm @error('firm_address') is-invalid @enderror" placeholder="Enter Firm Address"
                                                readonly>{{ old("firm_address",$quotation_details->firm_address)  }}</textarea>
                                            @error('firm_address')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-6 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="client_name" class="form-control">
                                                <option value="{{ old("client_name",Crypt::encrypt($quotation_details->customer_id)) }}">{{ $quotation_details->client_name }}</option>
                                            </select>
                                            @error('client_name')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                        ...
                                        {{-- <div class="form-group">
                                            <label for="client_name">Client Name <span class="text-danger">*</span></label>
                                            <input type="text" name="client_name" value="{{ $quotation_details->client_name }}"
                                                class="form-control @error('client_name') is-invalid @enderror"
                                                id="client_name" placeholder="client_name" maxlength="50" disabled>
                                            @error('client_name')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group pt-1">
                                            ...
                                            <textarea type="text" name="client_address" id="client_address" rows="4"
                                                ...
                                                placeholder="Enter Client Address">{{ old("client_address",$quotation_details->client_address) }}</textarea>
                                    ...
                                    <div class="col-md-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="dispatch_date"
                                                min="{{ now()->format('Y-m-d') }}" value="{{ old("dispatch_date",$quotation_details->dispatch_date) }}"
                                    ...
                                    <div class="col-md-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <select name="dispatch_status"
                                                ...
                                                id="dispatch_status">
                                                <option value="">Choose Status</option>
                                                <option value="pending" {{ old("dispatch_status",$quotation_details->dispatch_status) == "pending" ? "selected" : "" }}>Pending</option>
                                                <option value="hold" {{ old("dispatch_status",$quotation_details->dispatch_status) == "hold" ? "selected" : "" }}>Hold</option>
                                                <option value="dispatch" {{ old("dispatch_status",$quotation_details->dispatch_status) == "dispatch" ? "selected" : "" }}>Dispatch</option>
                                            </select>
                                ...
                                <div class="row mx-2">
                                    <div class="col-md-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="transport" value="{{ old("transport",$quotation_details->transport) }}"
                                                class="form-control @error('transport') is-invalid @enderror"
                                                id="transport" placeholder="Transport" maxlength="50">
                                            @error('transport')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="booking_destination" value="{{ old("booking_destination",$quotation_details->booking_destination) }}"
                                ...
                                <div class="row m-2">
                                    <div class="table-responsive">
                                        <table class="table" id="items_table">
                                            ...
                                            {{-- @dd($active_products) --}}
                                            <tbody id="tbody">
                                                <tr id="product-item-row-0" class="product-item-row-0" style="display: none;">
                                                        ...
                                                        <div class="form-group select-2-product-search">
                                                            <select name="quotation_product_ids[]"
                                                                ...
                                                                @foreach ($active_products as $product)
                                                                    <option value="{{ $product->id }}" {{ ($quotation_details->quotation_product_ids) == $product->id ? "selected" : "" }} >
                                                    ...
                                                    <td>
                                                        <button class="remRow btn btn-sm btn-danger" id="row-{{ count($quotation_details->particulars) + 1 }}"
                                                            type="button">
                                                ...
                                                @foreach ($quotation_details->particulars as $particular)
                                                    <tr id="product-item-row-{{$loop->iteration}}" class="product-item-row-0">
                                                        {{-- Select Products dropdown --}}
                                                        <td>
                                                            <div class="form-group select-2-product-search">
                                                                <select name="quotation_product_ids[]"
                                                                    class="form-control select-products" readonly>
                                                                    <option value="{{ $particular->product_id }}">{{ $particular->product_name }}</option>
                                                                    {{-- @dd($active_products) --}}
                                                                    {{-- @foreach ($active_products as $product)
                                                            ...
                                                            <div class="form-group">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <input type="number" min="0"
                                                                        name="quotation_product_nos[]"
                                                                        class="form-control form-control-sm @error('quotation_product_nos[]') is-invalid @enderror"
                                                                        id="quotation_product_nos[]" value="{{ $particular->product_nos }}">
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                <input type="number" min="0"
                                                                    name="quotation_product_packaging[]"
                                                                    class="form-control form-control-sm @error('quotation_product_packaging[]') is-invalid @enderror"
                                                                    value="{{ $particular->product_packaging }}" id="quotation_product_packaging[]"
                                                                    readonly>
                                                                @error('quotation_product_packaging[]')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                <input type="number" min="0"
                                                                    ...
                                                                    id="quotation_product_quantity[]"
                                                                    class="form-control form-control-sm @error('quotation_product_quantity[]') is-invalid @enderror"
                                                                    value="{{ $particular->product_quantity }}" readonly>
                                                                @error('quotation_product_quantity[]')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                <input type="text" min="0"
                                                                    ...
                                                                    id="quotation_product_price[]"
                                                                    class="form-control form-control-sm @error('quotation_product_price[]') is-invalid @enderror"
                                                                    value="{{ $particular->product_price }}">
                                                                @error('quotation_product_price[]')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                <input type="text" min="0"
                                                                    ...
                                                                    id="quotation_product_tax[]"
                                                                    class="form-control form-control-sm @error('quotation_product_tax[]') is-invalid @enderror"
                                                                    value="{{ $particular->product_gst }}" readonly>
                                                                @error('quotation_product_tax[]')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                <input type="number" min="0"
                                                                    ...
                                                                    id="quotation_product_amount[]"
                                                                    class="form-control form-control-sm @error('quotation_product_amount[]') is-invalid @enderror"
                                                                    value="{{ $particular->product_amount }}" readonly>
                                                                @error('quotation_product_amount[]')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                        ...
                                                        <td>
                                                            <button class="remRow btn btn-sm btn-danger" id="row-{{ $loop->iteration }}"
                                                                type="button">
                                                                <i class="fas fa-times"></i>
                                                            </button>
                                                        </td>
                                    ...
                                    <div class="col-6 col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                value="{{ $quotation_details->quotation_total }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" name="remarks" rows="4"
                                                ...
                                                maxlength="1500">{{ old("remarks",$quotation_details->remarks) }}</textarea>
                                            @error('remarks')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="row m-3">
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            <input type="number" min="0" name="payment_condition" value="{{ old("payment_condition",$quotation_details->payment_condition) }}"
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            <select
                                                ...
                                                <option value="days" {{ old("payment_time",$quotation_details->payment_time) == "days" ? "selected" : "" }}>Days</option>
                                                <option value="weeks" {{ old("payment_time",$quotation_details->payment_time) == "weeks" ? "selected" : "" }}>Weeks</option>
                                                <option value="months" {{ old("payment_time",$quotation_details->payment_time) == "months" ? "selected" : "" }}>Months</option>
                                                <option value="immediate" {{ old("payment_time",$quotation_details->payment_time) == "immediate" ? "selected" : "" }}>Immediate</option>
                                                <option value="none" {{ old("payment_time",$quotation_details->payment_time) == "none" ? "selected" : "" }}>None</option>
                                            </select>
                                            @error('payment_time')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            <select
                                                ...
                                                <option value="credit" {{ old("payment_type",$quotation_details->payment_type) == "credit" ? "selected" : "" }}>Credit</option>
                                                <option value="advance" {{ old("payment_type",$quotation_details->payment_type) == "advance" ? "selected" : "" }}>Advance</option>
                                                <option value="pdc" {{ old("payment_type",$quotation_details->payment_type) == "pdc" ? "selected" : "" }}>PDC</option>
                                                <option value="none" {{ old("payment_type",$quotation_details->payment_type) == "none" ? "selected" : "" }}>None</option>
                                            </select>
                                            @error('payment_type')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <select name="term_of_supply"
                                                ...
                                                <option value="to_pay" {{  old("term_of_supply",$quotation_details->term_of_supply) == "to_pay" ? "selected" : "" }}>To Pay</option>
                                                <option value="paid" {{  old("term_of_supply",$quotation_details->term_of_supply) == "paid" ? "selected" : "" }}>Paid</option>
                                            </select>
                                        </div>
                                        {{-- </div> --}}
                                    </div>
                                ...
                                <div class="row m-2">
                                    <div class="col-md-12 col-sm-12 d-flex justify-content-md-end mb-3"
                                        ...
                                        <button class="btn btn-primary" id="addInvoice" type="submit">
                                            <i class="fas fa-check" style="font-size: 12px;"></i> Update
                                        </button>
                                        {{-- </div> --}}
                                    </div>
                                </div>
...
@section('custom_scripts')
    ...
    <script type="text/javascript">
        $(function() {
            ...
            // initialize old pdf download request before update
            $('form').submit(function(e){
                if(!confirm("You are trying to update a quotation. Have you downloaded the old quotation ?")){
                    e.preventDefault();
                }
            });
            ...
            //     var clonedRow = $(".product-item-row-0").last().clone(true);
            //     clonedRow.insertBefore("#product-item-row-dummy");
            //     clonedRow.attr("id", "product-item-row-" + (noOfRows + 1));

            //     var set_product_nos = $("#product-item-row-" + (noOfRows + 1))
            //         .children()
            //         .find('input[id="quotation_product_nos[]"]')
            //         .val(0);
            //     var set_product_packaging = $("#product-item-row-" + (noOfRows + 1))
            //         .children()
            //         .find('input[id="quotation_product_packaging[]"]')
            //         .val(0);

            //     var set_quantity = $("#product-item-row-" + (noOfRows + 1))
            //         .children()
            //         .find('input[id="quotation_product_quantity[]"]')
            //         .val(0);

            //     var set_product_per_price = $("#product-item-row-" + (noOfRows + 1))
            //         .children()
            //         .find('input[id="quotation_product_price[]"]')
            //         .val(0);

            //     var set_product_per_tax = $("#product-item-row-" + (noOfRows + 1))
            //         .children()
            //         .find('input[id="quotation_product_tax[]"]')
            //         .val(0);

            //     var set_product_amount = $("#product-item-row-" + (noOfRows + 1))
            //         .children()
            ...
            $("#add_item").on("click", function() {
                $(".select-products").select2("destroy");
                var noOfRows = $(".product-item-row-0").length - 1;
                // console.log(noOfRows);
