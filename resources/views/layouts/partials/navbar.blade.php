                    ...
                    <div class="media align-items-center">
                        <span class="avatar avatar-sm rounded-circle">
                            @if (Auth::user()->user_detail->employee_image && file_exists(public_path('uploads/users/profile_images/'.Auth::user()->user_detail->employee_image))) 
                                <img alt="{{Auth::user()->full_name}}" src="{{ asset('uploads/users/profile_images/'.Auth::user()->user_detail->employee_image) }}">
                            @else
                                <img style="" alt="{{Auth::user()->full_name}}" src="{{ asset('uploads/users/default_user.png') }}">
                            @endif
