...
@section('content')
    <div>
        ...
        <div class="d-md-flex d-none justify-content-between card-header mb-2">
            ...
            <form action="{{ route('appointmentFilter_reports') }}" class="d-md-flex d-none" method="GET">
                                ...
                                <tbody class="list">
                                    ...
                                    @foreach ($all_appointments as $appointment)
                                        <tr>
                                            ...
                                            <td>{{ ucwords($appointment->addedBy->full_name) }}</td>
                                            <td>{{ ucwords($appointment->customerLeadDetails->customer_name) }}</td>
                                            <td>{{ date('jS M, Y', strtotime($appointment->appointment_date)) }}</td>
                                            <td>{{ $appointment->appointment_time }}</td>
                                            <td>{{ $appointment->appointmentWith->contact_person_name }}</td>
    ...
    <script>
        ...
        function ExportToExcel(type, fn, dl) {
            ...
            return dl ?
                ...
                XLSX.writeFile(wb, fn || ('AppointmentsReport.' + (type || 'xlsx')));
        }
    </script>
