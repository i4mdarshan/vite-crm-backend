        ...
        <div class="col-md-12">
            <div class="card shadow">
                ...
                <div class="d-flex justify-content-between card-header">
                    <h1 class="mb-0">Customer Notes Details</h1>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                                    ...
                                    <div class="col-md-6 mt-2">
                                        <div class="text-secondary border bg-secondary">
                                            <div class="p-2">
                                                ...
                                                <h3 class="m-0 p-0"><b>{{ date("jS F, Y",strtotime($note_info->notes_date)) }}</b></h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mt-2">
                                        <div class="text-secondary border bg-secondary">
                                            <div class="p-2">
                                                <span class="h5 mb-0">Notes Time</span>
                                                <h3 class="m-0 p-0"><b>{{ ($note_info->notes_time) }}</b></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <div class="text-secondary border bg-secondary">
                                            <div class="p-2">
                                                ...
                                                <h3 class="m-0 p-0">
                                                    <b>{{ ($note_info->notes_description) ? $note_info->notes_description : 'NA' }}</b>
                                                </h3>
                                            </div>
                                        </div>
                                    </div>
