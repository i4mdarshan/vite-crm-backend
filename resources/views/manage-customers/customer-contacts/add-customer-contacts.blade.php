        ...
        <div class="col-md-12">
            <div class="card shadow">
                ...
                <div class="d-flex justify-content-between card-header">
                    <h1 class="mb-0">Add Customer Contact Details</h1>
                </div>
                <form action="{{ route('saveContacts_customers', $customer_id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                <div class="card-body">
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="person_name"
                                    ...
                                    value="{{ old('person_name') }}" maxlength="40" placeholder="Enter Person Name">
                                @error('person_name')
