        ...
        <div class="col-md-12">
            <div class="card shadow">
                ...
                <div class="d-flex justify-content-between card-header">
                    <h1 class="mb-0">Edit Customer Contact Details</h1>
                </div>
                <form action="{{ route('updateContact_customers',['customer_id' => $customer_id, 'contact_id' => $contact_details->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                <div class="card-body">
                    <div class="row mt-3">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="person_name"
                                            ...
                                            value="{{ old("person_name",$contact_details->contact_person_name) }}" maxlength="40" placeholder="Enter Person Name">
                                        @error('person_name')
