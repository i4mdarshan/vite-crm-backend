        ...
        <div class="row">
            <div class="col-md-12 mb-3">
                <div class="card shadow">
                    ...
                    <form action="{{ route('save_customers') }}" method="POST">
                        @csrf
                        <div class="m-3">
                            <div class="row mx-2">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="customer_name">Enter Customer Firm Name <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="customer_name"
                                            class="form-control @error('customer_name') is-invalid @enderror"
                                            id="customer_name" value="{{ old('customer_name') }}" maxlength="255"
                                            placeholder="Enter Customer Firm Name">
                                        @error('customer_name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="customer_owner_name"
                                            ...
                                            id="customer_owner_name" value="{{ old('customer_owner_name') }}" maxlength="255"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('customer_type') is-invalid @enderror"
                                            ...
                                            <option value="manufacturer" {{ (old("customer_type") == "manufacturer") ? "selected" : ""}} >Manufacturer</option>
                                    ...
                                    @if ($employee_module_access == 1)
                                        <div class="form-group">
                                            <label for="customer_assigned_to">Assigned To <span class="text-danger">*</span></label>
                                            <select class="form-control @error('customer_assigned_to') is-invalid @enderror"
                                                ...
                                                <option value="{{ Auth::user()->id }}" {{ (old("customer_assigned_to") == Auth::user()->id) ? "selected" : "" }} >{{ Auth::user()->full_name }}
                                                </option>
                                                @foreach ($my_employees as $my_employees)
                                                    <option value="{{ $my_employees->id }}" {{ (old("customer_assigned_to") == $my_employees->id) ? "selected" : "" }} >
                                                        {{ $my_employees->full_name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group">
                                        <label for="customer_gst_no">Enter GST NO. <span class="text-danger">*</span>&nbsp;<small>(Enter 'NA' in case GST NO. is not provided.)</small></label>
                                        <input type="text" name="customer_gst_no" pattern="^(NA|[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[1-9A-Z]{1}Z[0-9A-Z]{1})$"
                                            title="Invalid GST NO." class="form-control @error('customer_gst_no') is-invalid @enderror" id="customer_gst_no"
                                            value="{{ old('customer_gst_no') }}" maxlength="100" placeholder="Enter GST NO. ">
                                ...
                                <div class="col-md-6">
                                        ...
                                        <div class="col-md-6 px-1">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="customer_no1"
                                                    ...
                                                    id="customer_no1" value="{{ old('customer_no1') }}"
                                        ...
                                        <div class="col-md-6 px-1">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="customer_no2"
                                                    ...
                                                    id="customer_no2" value="{{ old('customer_no2') }}"
                                        ...
                                        <div class="col-md-6 px-1">
                                            <div class="form-group">
                                                ...
                                                <input type="email" name="customer_mail"
                                                    ...
                                                    id="customer_mail" value="{{ old('customer_mail') }}" maxlength="50"
                                                    placeholder="Enter Customer Mail 1">
                                                @error('customer_mail')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-6 px-1">
                                            <div class="form-group">
                                                ...
                                                <input type="email" name="customer_mail2"
                                                    ...
                                                    id="customer_mail2" value="{{ old('customer_mail2') }}"
                                    ...
                                    <div class="row m-0">
                                        <div class="col-md-6 px-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="manager_name"
                                                    ...
                                                    id="manager_name" value="{{ old('manager_name') }}" maxlength="30"
                                        ...
                                        <div class="col-md-6 px-1">
                                            <div class="form-group">
                                                <label for="accountant_name">Enter Accountant's name</label>
                                                <input type="text" name="accountant_name"
                                                    class="form-control @error('accountant_name') is-invalid @enderror"
                                                    id="accountant_name" value="{{ old('accountant_name') }}"
                                                    maxlength="30" placeholder="Enter Customer Phone 2">
                                    ...
                                    <div class="row m-0">
                                        <div class="col-md-6 px-1">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="manager_number"
                                                    ...
                                                    id="manager_number" value="{{ old('manager_number') }}"
                                                    placeholder="Enter Customer Phone 2">
                                        ...
                                        <div class="col-md-6 px-1">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="accountant_number"
                                                    class="form-control @error('accountant_number') is-invalid @enderror"
                                                    id="accountant_number" value="{{ old('accountant_number') }}"
                                                    placeholder="Enter Customer Phone 2">
                                        ...
                                        <div class="col-md-12 px-1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="customer_website"
                                                    ...
                                                    id="customer_website" value="{{ old('customer_website') }}"
                                                    maxlength="1000" placeholder="Enter Customer Website ">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" rows="5" name="customer_notes"
                                                    class="form-control @error('customer_notes') is-invalid @enderror" id="customer_notes" maxlength="1500"
                                                    placeholder="Enter Customer Notes">{{ old('customer_notes') }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('address_line_1') is-invalid @enderror"
                                            name="address_line_1" id="address_line_1" value="{{ old('address_line_1') }}" maxlength="30"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('address_line_3') is-invalid @enderror"
                                            name="address_line_3" id="address_line_3" value="{{ old('address_line_3') }}" maxlength="30"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('address_line_5') is-invalid @enderror"
                                            name="address_line_5" id="address_line_5" value="{{ old('address_line_5') }}" maxlength="30"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="customer_country"
                                            ...
                                            id="customer_country" value="{{ old('customer_country') }}" maxlength="30"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="customer_district"
                                            ...
                                            id="customer_district" value="{{ old('customer_district') }}" maxlength="30"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="customer_pin_code"
                                            ...
                                            id="customer_pin_code" value="{{ old('customer_pin_code') }}" maxlength="30"
                                            placeholder="Enter Customer District">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('address_line_2') is-invalid @enderror"
                                            name="address_line_2" id="address_line_2" value="{{ old('address_line_2') }}" maxlength="30"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('address_line_4') is-invalid @enderror"
                                            name="address_line_4" id="address_line_4" value="{{ old('address_line_4') }}" maxlength="30"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('address_line_6') is-invalid @enderror"
                                            name="address_line_6" id="address_line_6" value="{{ old('address_line_6') }}" maxlength="30"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('customer_state') is-invalid @enderror"
                                            ...
                                            @foreach ($states as $state)
                                                <option value="{{ $state->state_id }}"  {{ (old("customer_state") == $state->state_id) ? "selected" : "" }}  >{{ $state->state_title }} -
                                                    {{ sprintf('%02d', $state->state_code) }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="customer_taluka"
                                            ...
                                            id="customer_taluka" value="{{ old('customer_taluka') }}" maxlength="30"
                                            placeholder="Enter Customer Taluka">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('o_address_line_1') is-invalid @enderror"
                                            name="o_address_line_1" id="o_address_line_1" value="{{ old('o_address_line_1') }}" maxlength="30"
                                            placeholder="Address Line 1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('o_address_line_3') is-invalid @enderror"
                                            name="o_address_line_3" id="o_address_line_3" value="{{ old('o_address_line_3') }}" maxlength="30"
                                            placeholder="Address Line 3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('o_address_line_5') is-invalid @enderror"
                                            name="o_address_line_5" id="o_address_line_5" value="{{ old('o_address_line_5') }}" maxlength="30"
                                            placeholder="Address Line 5">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="office_country"
                                            ...
                                            id="office_country" value="{{ old('office_country') }}" maxlength="30"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="office_district"
                                            ...
                                            id="office_district" value="{{ old('office_district') }}" maxlength="30"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="office_pin_code"
                                            ...
                                            id="office_pin_code" value="{{ old('office_pin_code') }}" maxlength="30"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('o_address_line_2') is-invalid @enderror"
                                            name="o_address_line_2" id="o_address_line_2" value="{{ old('o_address_line_2') }}" maxlength="30"
                                            placeholder="Address Line 2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('o_address_line_4') is-invalid @enderror"
                                            name="o_address_line_4" id="o_address_line_4" value="{{ old('o_address_line_4') }}" maxlength="30"
                                            placeholder="Address Line 4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('o_address_line_6') is-invalid @enderror"
                                            name="o_address_line_6" id="o_address_line_6" value="{{ old('o_address_line_6') }}" maxlength="30"
                                            placeholder="Address Line 6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('office_state') is-invalid @enderror"
                                            ...
                                            <option value="">Choose State</option>
                                            @foreach ($states as $state)
                                                <option value="{{ $state->state_id }}" {{ (old("office_state") == $state->state_id) ? "selected" : "" }} >{{ $state->state_title }} -
                                                    {{ sprintf('%02d', $state->state_code) }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        <label for="office_taluka">Enter Office's Taluka </label>
                                        <input type="text" name="office_taluka"
                                            class="form-control @error('office_taluka') is-invalid @enderror"
                                            id="office_taluka" value="{{ old('office_taluka') }}" maxlength="30"
