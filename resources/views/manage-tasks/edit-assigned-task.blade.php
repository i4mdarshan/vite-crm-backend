                    ...
                    <div class="m-1">
                        <a href="{{ route('assigned_tasks') }}" class="btn btn-primary px-3">
                            <span class="text-secondary h3"><i class="ni ni-bold-left mr-2"
                                    style="font-size: 14px; vertical-align: middle;"></i>Assigned Tasks</span>
                        </a>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row mx-2">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="task_title"
                                                ...
                                                id="task_title" value="{{ old('task_title',$task_info->task_title) }}" maxlength="255"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="task_assigned_by"
                                                class="form-control @error('task_assigned_by') is-invalid @enderror"
                                                id="task_assigned_by" value="{{ old('task_assigned_by',$task_info->assigned_by->full_name) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            class="text-danger">*</span></label>
                                        <select class="form-control @error('task_assigned_to') is-invalid @enderror" name="task_assigned_to"
                                                id="task_assigned_to">
                                            <option value="">Choose Employee</option>
                                            @foreach ($my_employees as $my_employee)
                                            <option value="{{ $my_employee->id }}" {{ (old("task_assigned_to",$task_info->task_assigned_to) == $my_employee->id) ? 'selected' : '' }} >{{ $my_employee->full_name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" name="task_description" rows="10"
                                                ...
                                                id="task_description" maxlength="4000"
                                                placeholder="Enter Task Description">{{ old("task_description",$task_info->task_description) }}</textarea>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" name="task_notes" rows="10" class="form-control" maxlength="4000" placeholder="Enter Task notes">{{ old("task_notes",$task_info->task_notes) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
