        ...
        <div class="col-md-12">
            <div class="card shadow">
                ...
                <div class="d-flex justify-content-between card-header">
                    <h1 class="mb-0">Add Lead Appointment</h1>
                </div>
                <form action="{{ route('saveAppointment_leads', $lead_id) }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="row mt-3">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" min="{{ date('Y-m-d') }}" name="appointment_date"
                                        ...
                                        value="{{ old('appointment_date') }}" placeholder="Enter Person Name">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="appointment_time"
                                        class="form-control CallTimePicker @error('appointment_time') is-invalid @enderror" id="appointment_time"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea
                                        class="form-control @error('appointment_description') is-invalid @enderror"
                                        name="appointment_description" id="appointment_description" rows="5" maxlength="1500"
                                        placeholder="Enter Description">{{old('appointment_description')}}</textarea>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('input.CallTimePicker').timepicker({
                ...
                maxTime: '{{ Carbon::now()->endOfDay()->format("H:i:m") }}',
                dynamic: false,
                dropdown: true,
                scrollbar: true
            });
