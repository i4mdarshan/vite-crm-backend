    ...
    <div class="row">
        <div class="col-md-12">
            @if (count($customer_contacts) == 0)
                <div class="row">
                    <div class="alert alert-danger mb-3 py-3 px-0 w-100" role="alert">
                        <ul class="mt-0 mb-0">
                            <li>You have not added any contacts in contacts section. Please add a contact to add call details.</li>
                        </ul>
                    </div>
                </div>
            @endif
            ...
            <div class="card shadow">
                ...
                <div class="d-flex justify-content-between card-header">
                    <h1 class="mb-0">Add Lead Call</h1>
                </div>
                <form action="{{ route('saveCalls_leads', $lead_id) }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="row mt-3">
                            <div class="col-md-4">
