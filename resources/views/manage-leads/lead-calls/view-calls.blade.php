            ...
            <div class="col-md-12">
                <div class="card shadow">
                    ...
                    <div class="d-flex justify-content-between card-header">
                        <h1 class="mb-0">Lead Calls Details</h1>
                                        ...
                                        <div class="col-md-4 mt-2">
                                            <div class="text-secondary border bg-secondary">
                                                <div class="p-2">
                                                    ...
                                                    <h3 class="m-0 p-0">
                                                        <b>{{ date("jS F, Y", strtotime($calls_info->call_date)) }}</b></h3>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 mt-2">
                                        ...
                                        <div class="col-md-4 mt-2">
                                            <div class="text-secondary border bg-secondary">
                                                <div class="p-2">
                                                    ...
                                                    <h3 class="m-0 p-0"><b>{{ ucwords($calls_info->callWith->contact_person_name) }}</b></h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
